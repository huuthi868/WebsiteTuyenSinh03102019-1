    ...
    registerEvent: function () {
        $('.btnDangKy').off('click').on('click', function (e) {
            ...
            if (NgheID === 0 || HoTen === '' || NgaySinh === '' || HKTT === '' || DiaChi === '' || DienThoai === '' || TenTruongTotNghiep === '' || DiemLop10 === '' || DiemLop11 === '' || DiemLop12 === '') {
                ...
                $.toast({
                    heading: 'Thông báo',
                    text: 'Nhập ngày, tháng, năm sinh không đúng hoặc tuổi không đúng',
                    position: 'top-right',
                    loaderBg: '#ff6849',
                    icon: 'error',
                    hideAfter: 4000,
                ...
                DangKyCaoDangjs.saveData();
            }
        });

        $('#DiemLop10').off('change').on('change', function (e) {
            DangKyCaoDangjs.TongDiem();
        });
                    ...
                    bootbox.dialog({
                        ...
                        buttons: {
                            ...
                            confirm: {
                                ...
                                callback: function () {
                                    window.location.href = '/ket-qua/tim-kiem?hoten=' + model.HoTen + '&ngaysinh=' + model.NgaySinh + '&hedangky=cao-dang';
                                }
                            }
                        },
                        callback: function () {
